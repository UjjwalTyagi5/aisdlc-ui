...
OPTIONAL_DEFAULTS = {
    ...
    "WORKER_RECLAIM_TIMEOUT_MS", "TEMPORAL_TASK_QUEUE", "SLA_REQUIREMENTS_HOURS",
...
# Legacy keys still referenced by env.py but slated for removal (AzureOpenAI/SQLServer).
LEGACY = {
    "AGENTIC_APP_PATH",
    "AZURE_OPENAI_API_KEY", "AZURE_OPENAI_ENDPOINT", "AZURE_OPENAI_DEPLOYMENT",
    "AZURE_OPENAI_API_VERSION", "OPENAI_API_KEY", "SQLSERVER_CONN_STRING",
}
