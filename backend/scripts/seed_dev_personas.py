...
def _write_credentials_file(rows: list[tuple[str, str, str, str]]) -> pathlib.Path:
    ...
    lines += [
        ...
        "  3. As ana@, raise a budget increase from Cost & Budget. It climbs to",
        "     the BU Admin first, same as any Project Admin's ask, and escalates",
        "     to the Org Admin from there if needed.",
        "     Approving it MOVES the cap — check the project afterwards.",
