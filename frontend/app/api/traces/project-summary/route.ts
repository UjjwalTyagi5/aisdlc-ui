 ...
 * caller's default scope. The backend does that now; the fixture version this
 * replaced answered from a local mock (since deleted) and, tellingly, stamped
 * every response with a hardcoded `generatedAt` of 17 June 2026.
 */
